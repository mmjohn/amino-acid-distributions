...
This is the RMarkdown document used to produce Supplementary Figure 3. It compares results for fitting distributions with a different number of parameters for all empirical MSAs.
...
ggplot(results_corr, aes(x = param, y = r2)) +
  ...
  theme(
    ...
    axis.title.y = element_markdown()) -> figs3

figs3
# blue points, light blue lines
# box plots included?
# jitter?

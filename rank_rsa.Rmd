...
protein_rsa <- tibble(filename_emp = empirical_files) %>%
  extract(
    filename_emp, 
    "protein", 
    "array_(.*).dat", 
...
protein_rsa <- rename(protein_rsa, RSA_emp = RSA)
protein_rsa2 <- rename(protein_rsa2, RSA_sim = RSA)
protein_rsa_full <- full_join(protein_rsa, protein_rsa2)

rm(protein_rsa, protein_rsa2, empirical_files, simulated_files)

...
observed_aa_mod %>% 
  ...
  ) %>% unnest(cols = data) -> observed_aa_mod

observed_aa_mod$optimal_ridge_lambda <- as.numeric(observed_aa_mod$optimal_ridge_lambda)
...
summary(observed_aa_mod$optimal_ridge_lambda)
...
fit <- glmnet(
  cbind(one_site_example$k, one_site_example$k2), 
  one_site_example$ln_count, 

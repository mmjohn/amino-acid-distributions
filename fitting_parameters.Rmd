...
Relationship between regularization $\lambda$ and $n_{eff}$
```{r, message=FALSE}
...
compare_eff_aa %>% 
  ...
  background_grid() -> figs6_2

plot_grid(figs6_1, figs6_2, ncol = 2,
          align = "h", axis = "bt", rel_widths = c(1, 1.3)) -> figs6
...
ggplot(all_results_mod, 
  ...
  theme(
    axis.title.x = element_markdown(),
    axis.title.y = element_markdown(),
    strip.background = element_rect(fill = "gray90")) -> figs7

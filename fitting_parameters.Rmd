...
rsq(compare_p1$eff_aa, compare_p1$eff_aa_est) # 0.9698161
...
signif(0.9698161, digits = 3)
signif(0.8203932, digits = 3)
signif(0.7725455, digits = 3)

dat_text <- data.frame( label = c("*R*<sup>2</sup> = 0.970", 
                                  "*R*<sup>2</sup> = 0.820", 
                                  "*R*<sup>2</sup> = 0.772"),
                        parameters = c(1, 2, 3),
